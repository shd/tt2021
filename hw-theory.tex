...
\section*{Домашнее задание №8: <<непрерывность; связность; равенство в гомотопической теории типов>>}
\begin{enumerate}
...
без конечного количества точек: $X \setminus \{a_0, a_1, \dots, a_{n-1}\}$). 
\begin{enumerate}
