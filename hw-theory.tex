...
\item Какой ранг имеет тип этой функции? Докажите, что он не равен 1.
\item Реализуйте предложенный тип на Хаскеле (используйте опцию \verb!RankNTypes!).
Предложите функцию для удаления элемента списка (головы).
...
(б) попробуйте выписать тип функции \verb!strange_pair!.
